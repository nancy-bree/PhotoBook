...
$(window).load(function () {
    ...
    if ($defaultViewMode == "full") {
        $toolbar_a.html("<img src='/Scripts/gallery/toolbar_n_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('normal');return false").attr("title", "Restore");
    } else {
        $toolbar_a.html("<img src='/Scripts/gallery/toolbar_fs_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('full');return false").attr("title", "Maximize");
    }
